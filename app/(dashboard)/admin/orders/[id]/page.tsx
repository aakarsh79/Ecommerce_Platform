          ...
          {orderProducts?.map((product) => (
            <div className="flex items-center gap-x-4" key={product?.id}>
              ...
              <div>
                ...
                <p>
                  {formatINR(product?.product?.price)} * {product?.quantity} items
                </p>
              </div>
            </div>
          ))}
          <div className="flex flex-col gap-y-2 mt-10">
            <p className="text-2xl">Subtotal: {formatINR(order?.total)}</p>
            <p className="text-2xl">Tax 20%: {formatINR(order?.total / 5)}</p>
            <p className="text-2xl">Shipping: {formatINR(5)}</p>
            <p className="text-3xl font-semibold">
              Total: {formatINR(order?.total + order?.total / 5 + 5)}
            </p>
          </div>
