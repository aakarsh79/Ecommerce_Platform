      ...
      <Slider {...settings}>
        <div className="h-[500px] max-lg:h-[400px] max-md:h-[250px] max-[500px]:h-[200px] max-[400px]:h-[150px] relative">
          ...
          <div className="relative w-full h-full">
            <Image src="/slider image 1.webp" alt="slider 1" fill className="object-cover" sizes="100vw" priority />
          </div>
        </div>
        <div className="h-[500px] max-lg:h-[400px] max-md:h-[250px] max-[500px]:h-[200px] max-[400px]:h-[150px] relative">
          <div className="absolute left-[50%] translate-x-[-50%] translate-y-[30%] h-full text-center max-lg:translate-y-[25%] max-md:translate-y-[20%] max-sm:hidden z-10">
            <p className="text-xl font-light underline underline-offset-4 mb-5 max-[1162px]:text-lg max-lg:mb-2 max-md:text-base max-md:mb-1">
              Earbud
            </p>
            <h2 className="text-5xl font-light mb-5 max-[1162px]:text-4xl max-lg:mb-2 max-lg:text-3xl max-md:text-2xl max-md:mb-1">
          ...
          <div className="relative w-full h-full">
            <Image src="/slider image 2.webp" alt="slider 2" fill className="object-cover" sizes="100vw" />
          </div>
        </div>
      </Slider>
    </div>
